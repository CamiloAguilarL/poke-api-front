...
export const buttonVariants = cva(
  'inline-flex touch-manipulation shrink-0 items-center justify-center gap-2 rounded-2xl font-semibold transition-colors disabled:pointer-events-none disabled:opacity-45',
  {
    variants: {
      variant: {
        primary:
