...
<template>
  <DialogRoot :open="open" @update:open="emit('update:open', $event)">
    <DialogPortal>
      <DialogOverlay class="fixed inset-0 z-40 bg-black/45 data-[state=open]:animate-in" />
      <DialogContent
      ...
      >
        <div class="mx-auto mt-2 h-1 w-10 rounded-full bg-[#c9c9c9] md:hidden" aria-hidden="true" />
        <div class="sr-only">
