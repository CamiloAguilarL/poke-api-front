...
| ------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| MAIL-01 | El diseño provisto está optimizado para mobile y debe adaptarse a desktop/web. | Mobile coincide con los frames de Figma; desktop usa shell master-detail. |
| USER-01 | Vue, Pinia, Tailwind y shadcn-vue son obligatorios.                            | Dependencias, configuración y componentes centralizados presentes.        |
| USER-02 | Componentes basados en tokens del sistema de diseño.                           | Tokens semánticos centralizados; vistas sin colores crudos.               |
