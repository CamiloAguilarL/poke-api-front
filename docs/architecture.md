...
```text
PokeAPI GraphQL (catálogo y resúmenes) + REST (detalle)
...
- `≥1024 px`: shell al 100% del viewport y rail de 104 px. La ruta de catálogo ocupa todo el ancho útil con una grilla adaptativa de hasta cinco columnas. Cuando existe una ficha seleccionada, el catálogo conserva 420 px y activa el detalle master-detail; la composición de la ficha se centra en un máximo de 1120 px con columnas de ilustración y lectura proporcionadas. Ambos paneles conservan scroll independiente y cada cambio de Pokémon reinicia la ficha arriba sin desmontarla por cambios de búsqueda.
